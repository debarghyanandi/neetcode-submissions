...
node scripts/compile-check.mjs                        # every .cs file builds, free
```
...
9. **Fail loudly, measure publicly.** 270 tests and a full compile of every solution run before the first paid call;
